...
public class Question4 {
	...
	public static String section_i() {
		String answer = null;
		 answer = "Tetha(1)"; // unsorted remains unsorted, leave end of array blank
	...
	public static String section_ii() {
		...
		// answer = "Tetha(log(n))";
		// answer = "Tetha(sqrt(n))"; // sqrt is an abbreviation for square root
		 answer = "Tetha(n)";// worst case, shift n-1 cells
		// answer = "Tetha(n^(3/2))";
		// answer = "Tetha(nlog(n))";
		// answer = "Tetha(nlog^2(n))";
		// answer = "Tetha(n^2)";
	...
	public static String section_iii() {
		String answer = null;
		 answer = "Tetha(1)"; //save node in stack, direct implementation to node + actions are O(1)
		// answer = "Tetha(log(log(n)))";
		// answer = "Tetha(log(n))";
		// answer = "Tetha(sqrt(n))"; // sqrt is an abbreviation for square root
		// answer = "Tetha(n)";
